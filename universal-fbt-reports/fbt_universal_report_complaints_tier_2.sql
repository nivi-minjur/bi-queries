...
, final as (
    ...
    where zendesk_complaints_temp.brand_id in (select brand_id from fbt_brands)
        ...
        and zendesk_complaints_temp.custom_criticality in ('tier_2', 'tier_3')
)
...
, stakeholder_review as (
    ...
    where report_table_name = 'fbt_universal_report_complaints_tier_2'
...
select
    final.*
    , 'fbt_universal_report_complaints_tier_2' as table_name
