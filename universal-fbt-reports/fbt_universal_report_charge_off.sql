...
, final as (
    select
        ...
        , product_account_status_events.status
    ...
    where product_account_status_events.status = 'CHARGE_OFF'
...
, stakeholder_review as (
    ...
    where report_table_name = 'fbt_universal_report_charge_off'
...
select
    final.*
    , 'fbt_universal_report_charge_off' as table_name
