...
, final as (
    ...
    where product_account_status_events.status_reason in ('SCRA', 'CONVERTED_SCRA')
        and product_account_status_events.is_treatment = 'True'
...
, stakeholder_review as (
    ...
    where report_table_name = 'fbt_universal_report_scra'
...
select
    final.*
    , 'fbt_universal_report_scra' as table_name
