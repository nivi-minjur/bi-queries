...
, final as (
    select
        ...
        , product_account_status_events.status_reason_code
    ...
    where product_account_status_events.status_reason_code = 'ID_THEFT'
...
, stakeholder_review as (
    ...
    where report_table_name = 'fbt_universal_report_id_theft_claims'
...
select
    final.*
    , 'fbt_universal_report_id_theft_claims' as table_name
